...
then 
    ...
    then
		...
		do
			...
			echo "${CONDA_BIOBAMBAM_ENV} && perl ${MARVEL_PATH}/scripts/two_read_bam_combiner_sanger.pl ${b1} ${b2} samtools ${SC_HIC_MINMAPQV} | samtools view -bS -t ${ref}.fai - | samtools sort -o ${o} -"			 				 
